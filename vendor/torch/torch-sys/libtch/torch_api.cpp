...
bool tch_write_stream_destructor(void *ptr) { return true; }

bool tch_write_stream_write(void *ptr, const uint8_t *data, size_t length,
                            size_t *n) {
  return true;
}

bool tch_read_stream_destructor(void *ptr) { return true; }

bool tch_read_stream_stream_position(void *ptr, uint64_t *pos) { return true; }

bool tch_read_stream_seek_end(void *ptr, int64_t offset, uint64_t *pos) {
  return true;
}

bool tch_read_stream_seek_start(void *ptr, uint64_t pos, uint64_t *new_pos) {
  return true;
}

bool tch_read_stream_read(void *ptr, uint8_t *data, size_t length, size_t *n) {
  return true;
}
