...
pub const DiagnosticCode = enum {
    ...
    invalid_triton_launch_kernel,
    invalid_triton_launch_grid,
    missing_triton_comptime_arg,
    triton_launch_meta_mismatch,
...
pub fn diagnosticMessageFmt(code: DiagnosticCode) []const u8 {
    return switch (code) {
        ...
        .closure_escape_not_supported => "captured closures cannot escape the current function yet",
        ...
        .invalid_named_argument => "named arguments are only supported for triton.launch",
        .duplicate_named_argument => "duplicate named argument",
        .invalid_triton_launch_kernel => "triton.launch expects a triton kernel function",
        .invalid_triton_launch_grid => "triton.launch expects grid to be a tuple of 3 integers",
        .missing_triton_comptime_arg => "missing required comptime argument '{s}' for triton kernel specialization",
        .triton_launch_meta_mismatch => "triton.launch metadata '{s}' must be consistent across launches",
        ...
        .comptime_eval_failed => "comptime evaluation failed: {s}",
